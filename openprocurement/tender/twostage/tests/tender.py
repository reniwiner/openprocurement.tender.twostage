...
from openprocurement.tender.twostage.tests.base import (test_tender_data,
                                                      BaseTenderWebTest)
...
class TenderTest(BaseTenderWebTest):
    ...
    def test_simple_add_tender(self):
        ...
        assert u.procurementMethodType == "aboveThresholdTS"
        assert fromdb['procurementMethodType'] == "aboveThresholdTS"
...
class TenderResourceTest(BaseTenderWebTest):
    ...
    def test_create_tender_generated(self):
        ...
        self.assertEqual(set(tender), set([
            ...
            u'awardCriteria', u'submissionMethod', u'title', u'title_en',  u'date', u'operator']))
    ...
    def test_patch_tender_twostage(self):
        response = self.app.post_json('/tenders', {'data': test_tender_data})
        self.assertEqual(response.status, '201 Created')
        tender = response.json['data']
        owner_token = response.json['access']['token']
    ...
    def test_invalid_bid_tender_features(self):
        ...
        response = self.app.post_json('/tenders/{}/bids'.format(tender_id),
                                      {'data': {'parameters': [{"code": "OCDS-123454-POSTPONEMENT" ,"value": 0.1}],
